...
**bssl-ram** community a harassment-free experience for everyone, regardless of
...
- Focusing on what is best not just for us as individuals, but for the overall
  community
- Keeping technical disagreements technical — benchmarks, traces, and
  reproducible reports beat rhetoric
...
- Submitting intentionally malicious code, backdoors, or data-exfiltration
  patches — bssl-ram runs with `CAP_SYS_PTRACE` on user systems and we treat
  supply-chain hygiene as part of this Code
...
pull requests, discussions, and any other project-adjacent channel — and also
...
reported privately to the maintainers via **GitHub's private vulnerability /
abuse report channel** on this repository, or by opening a report through
GitHub Support if a maintainer is the subject of the complaint.
